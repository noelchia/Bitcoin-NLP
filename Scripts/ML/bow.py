...
df = pd.read_parquet(
    "tokens.parquet", columns=["time", "cleaned"], engine="pyarrow",
)
...
cv = CountVectorizer(tokenizer=dummy, lowercase=False, preprocessor=dummy, min_df=100)
